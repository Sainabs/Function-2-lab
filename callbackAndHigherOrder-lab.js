...
// CODE HERE
const last =(array,callBack)=>callBack(names[6])
...
// CODE HERE 
// const contains=(array,name, callBack)=>callBack(name[3])
...
// function hasUniq(names,callBack){
//   let uniqueChars = new Set([])
//   for (let i=0; i<names.length;i++){
//     uniqueChars.add(names[i])  
//   }
//   return uniqueChars.size===names.length
// }
// console.log(hasUniq(names))
