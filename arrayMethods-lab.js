...
//without arrow function
// const postTaxPrices = prices.filter(function(element){
//   return element*1.07
//   } )

//(callBack /* Provide Your Callback Here );
////////// PROBLEM 3 //////////
...
// CODE HERE
const totalPopulation= populations.reduce((ac, cur) => ac + cur)
...
/*
  ...
  Instead of just arrays of numbers, we are going to have an array of objects that we want to use map, filter, and reduce with.///use one of these
...
// CODE HERE
//orders.forEach((element,i)>=console.log(`${price} ${i}`))


 const ordersTotal =orders.map(order => order.price + (order.price * order.tax))
console.log(ordersTotal)
// const ordersTotal =orders.map(function (order){
//   return order.price + (order.price * order.tax)
// }) 
// console.log(ordersTotal)


//const ordersTotal =orders.map(obj => obj.price + (order.price * order.tax))
//console.log(ordersTotal)



// //wrong//const totalTaxRate=orders.reduce(obj.price=>obj.tax ((a, cc))
